import { GraduationStatsTab } from "@/components/exams/graduation/GraduationStatsTab";
  ...
  return (
    <div className="p-6 w-full space-y-6 bg-slate-50 min-h-screen">
      <div className="flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-slate-200">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Thống Kê Tốt Nghiệp</h1>
