...
import { getConfigRates, getAvailableResources, createCourse } from '@/actions/courses';
import { Check, Info, Loader2, Truck, UserCircle2 } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500 font-medium mt-1">Yêu cầu chọn: <strong className="text-indigo-600">{requiredCount} Xe & {requiredCount} GV</strong></p>
              </div>
              <div className="space-y-2">
